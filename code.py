...
FLOW_TRAIN = r'E:/jupyternotebook/JData/flow_train.csv'
TRANSITION_TRAIN = r'E:/jupyternotebook/JData/transition_train.csv'
flow_train = pd.read_csv(FLOW_TRAIN)
tran_train = pd.read_csv(TRANSITION_TRAIN)
